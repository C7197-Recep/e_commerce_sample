...
declare const ECommerceSampleApplication_base: (new (...args: any[]) => {
    projectRoot: string;
    ...
    prependOnceListener: (event: string | symbol, listener: (...args: any[]) => void) => import("@loopback/core").Application;
    eventNames: () => (string | symbol)[];
}) & import("@loopback/core").MixinTarget<import("@loopback/core").Application>;
export declare class ECommerceSampleApplication extends ECommerceSampleApplication_base {
